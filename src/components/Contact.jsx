        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          <div className='space-y-8 reveal reveal-delay-2'>
            <div className='flex items-center gap-5'>
              <div className='w-12 h-12 rounded-xl bg-white/[0.03] border border-white/[0.05] flex items-center justify-center text-zinc-400'>
              ...
              <div>
                ...
                <a
                  ...
                  className='text-sm text-zinc-300 hover:text-zinc-100 transition-colors font-body'
                >
            ...
            <div className='flex gap-3'>
              {socialLinks.map((s) => (
                <a
                  key={s.name}
                  href={s.url}
                  className='w-10 h-10 rounded-xl bg-white/[0.03] border border-white/[0.05] flex items-center justify-center hover:bg-white/10 transition-all text-zinc-400 hover:text-zinc-200'
                  aria-label={s.name}
                >
          ...
          <form onSubmit={handleSubmit} className='space-y-5 reveal reveal-delay-3'>
            <div>
              <label className='text-xs text-zinc-500 font-medium mb-1.5 block' htmlFor='name'>
                Your Name
              </label>
              <input id='name' type='text' placeholder='John Doe' required />
            </div>
            <div>
              <label className='text-xs text-zinc-500 font-medium mb-1.5 block' htmlFor='email'>
                Your Email
              </label>
              <input id='email' type='email' placeholder='john@example.com' required />
            </div>
            <div>
              <label className='text-xs text-zinc-500 font-medium mb-1.5 block' htmlFor='message'>
                Message
              </label>
